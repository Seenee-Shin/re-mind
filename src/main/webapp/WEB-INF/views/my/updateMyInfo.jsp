...
<article class="main_content">
    ...
    <table class="table">
        ...
        <tr>
            <td>이메일</td>
            <td><input class="email-input" type="email" value="user01@naver.com"></td>
        </tr>
        <tr>
            <td>휴대전화</td>
            <td>
    ...
    <div class="update-info">
        ...
        <div class="pwResult">
            입력 : <input type="password"> <span class="pwSpan">유효성</span><br>
          	확인 : <input type="password"><span class="pwSpan">일치 불일치</span>
