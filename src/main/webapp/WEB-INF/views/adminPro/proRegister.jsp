...
<main>
    ...
    <form action="proRegister" method="post" onsubmit="return validate();">
        <div class="proWrap">
            ...
            <input type="email" name="professionId" id="professionId" required placeholder="이매일을 입력해주세요"> 
            <div id="checkEmail"></div> <br>

            <div class="label">
            비밀번호 
            </div>
            <input type="password" name="professionPw" id="proPw" value="123123!" required >
            ...
            <input type="password" name="proPwCheck" id="proPwCheck" value="123123!" required>
            <div id="checkPw2"></div> <br>
            
            <div class="label"> 이름</div>
            <input type="text" name="professionName" id="proName" value="임철" required> <br>

            <div class="label">생년월일</div>
            <input type="text" name="professionBirth" id="proBirth" value="1991/11/21" required placeholder="0000/00/00"> <br>
            ...
            <input type="text" name="professionPhone" id="proPhone" required value="010-2345-2345" placeholder="000-0000-0000"> <br>
